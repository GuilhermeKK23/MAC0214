...
Upsolving da B da [Final Brasileira de 2024](https://codeforces.com/gym/105505). Pensei um pouco nesse problema durante o simulado, tive algumas observações usando a Bridge Tree, construída a partir do Algoritmo de Tarjan, mas não consegui resolver. Depois, vi a solução e ela usava uma ideia bem similiar usando o Algoritmo de Tarjan, e consegui implementar fazendo algumas adaptações

#
### 04/08/2026 - Problema do Codeforces - 30min

Resolvi o problema [Divisibility Game](https://codeforces.com/contest/2203/problem/D), da faixa dos 1700 de rating.

#
### 05/08/2026 - Problema do Codeforces - 30min

Resolvi o problema [Recollect Numbers](https://codeforces.com/contest/2201/problem/B), da faixa dos 1700 de rating.

#
### 06/08/2026 - Problema do Codeforces - 30min
...
Upsolving dos problemas A, G e H da [Seletiva USP](https://codeforces.com/gym/106636). Também recodei todas as questões que meu time fez durante a prova. Os problemas A e H foram os mais legais de resolver, pois sabíamos resolver eles durante a prova, mas não conseguimos codar a tempo. O problema G tinha a proposta de ser bem chato, e realmente foi, mas aprendi alguns truques legais de implementação ao upsolvar ele.

#
### 11/08/2026 - Upsolving - 2h

Upsolving do problema A da [Seletiva USP](https://codeforces.com/gym/106636). A solução esperada usava Hash, usei uma ideia parecida para implementar usando Suffix Array e Aho-Corasick. A solução com Suffix Array foi bem difícil de implementar, pois as buscas binárias necessárias eram bem delicadas e errei vários off-by-ones antes de conseguir resolver.

#
### 12/08/2026 - Upsolving e Conteúdo - 4h

Upsolving do problema F da [Seletiva USP](https://codeforces.com/gym/106636). Uma das soluções esperadas usava Centroid Decomposition, que foi como um membro do meu time fez durante a prova. Para praticar o conteúdo, eu decidi implementar esse problema também.
...
#
### 19/08/2026 - Problema do Codeforces - 30min
